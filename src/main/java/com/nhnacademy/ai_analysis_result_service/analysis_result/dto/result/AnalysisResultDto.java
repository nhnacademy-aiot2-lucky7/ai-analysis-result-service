...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = ThresholdDiffAnalysisResult.class, name = "THRESHOLD_DIFF_ANALYSIS"),
        @JsonSubTypes.Type(value = CorrelationRiskPredictResult.class, name = "CORRELATION_RISK_PREDICT")
})
